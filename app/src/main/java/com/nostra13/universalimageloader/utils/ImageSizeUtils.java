...
public final class ImageSizeUtils {
	...
	private static final int DEFAULT_MAX_BITMAP_HEIGHT_DIMENSION = 1024 * 2;

	private static final int DEFAULT_MAX_BITMAP_WIDTH_DIMENSION = 1024 * 2;
	...
	static {
		...
		int maxBitmapWidthDimension = Math.max(maxTextureSize[0],
				DEFAULT_MAX_BITMAP_WIDTH_DIMENSION);
		int maxBitmapHeightDimension = Math.max(maxTextureSize[0],
				DEFAULT_MAX_BITMAP_HEIGHT_DIMENSION);
		maxBitmapSize = new ImageSize(maxBitmapWidthDimension,
				maxBitmapHeightDimension);
	}
	...
	public static int computeImageSampleSize(ImageSize srcSize,
		...
		L.e("size", srcWidth + ":" + srcHeight + ":" + targetWidth + ":"
				+ targetHeight);
