...
public class LimitedAgeDiscCache extends BaseDiscCache {
	...
	public LimitedAgeDiscCache(File cacheDir, long maxAge) {
		this(cacheDir, null, DefaultConfigurationFactory
				.createFileNameGenerator(), maxAge);
	}
	...
	public LimitedAgeDiscCache(File cacheDir, File reserveCacheDir, long maxAge) {
		this(cacheDir, reserveCacheDir, DefaultConfigurationFactory
				.createFileNameGenerator(), maxAge);
	}
	 ...
	 *            reloaded).
	 */
	public LimitedAgeDiscCache(File cacheDir, File reserveCacheDir,
