...
public abstract class ViewAware implements ImageAware {
	...
	@Override
	public boolean setImageDrawable(Drawable drawable, String path) {
		if (Looper.myLooper() == Looper.getMainLooper()) {
			View view = viewRef.get();
			if (view != null) {
				setImageDrawableInto(drawable, view, path);
				return true;
			}
		} else {
	...
	@Override
	public boolean setImageBitmap(Bitmap bitmap, String path) {
		if (Looper.myLooper() == Looper.getMainLooper()) {
			View view = viewRef.get();
			if (view != null) {
				setImageBitmapInto(bitmap, view, path);
				return true;
			}
		} else {
