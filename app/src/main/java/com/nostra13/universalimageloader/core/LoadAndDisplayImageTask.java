...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public LoadAndDisplayImageTask(ImageLoaderEngine engine,
			ImageLoadingInfo imageLoadingInfo, Handler handler,int width,int height,int isBig) {
		this.engine = engine;
...
//			if (memoryCacheKey.startsWith("file://")) {
	...
	private boolean resizeAndSaveImage(int maxWidth, int maxHeight)
		...
		if (targetFile != null && targetFile.exists()) {
			...
			ImageDecodingInfo decodingInfo = new ImageDecodingInfo(
					...
					ViewScaleType.FIT_INSIDE, getDownloader(), specialOptions,width,height,isBig);
