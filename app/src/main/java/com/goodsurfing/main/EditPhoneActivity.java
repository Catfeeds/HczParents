...
public class EditPhoneActivity extends BaseActivity {
    private final static String TAG = "EditPhoneActivity";
            ...
            public void onResult(DataServiceResult result) {
                try {
                    ...
                    if ("000000".equals(errCode)) {
                        ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, true, "发送验证码成功");
                        time = 60;
                        mHandler.sendEmptyMessageDelayed(RegisterCodeTimer.IN_RUNNING, 0);
                    } else {
                        time = 60;
                        ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, false, "发送验证码失败");
    ...
    private void doSignCode() {
        ...
        new BindPhoneCodeServer(this, url, new DataServiceResponder() {
            ...
            public void onFailure() {
                isOnclick = true;
                ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, false, "验证失败");
            }
                ...
                public void handleMessage(Message msg) {
                    switch (msg.what) {
                        case What.HTTP_REQUEST_CURD_SUCCESS:
                            ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, true, "修改成功");
                            onBackPressed();
                            break;
                        case What.HTTP_REQUEST_CURD_FAILURE:
                            ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, false, msg.obj.toString());
                            break;
                    }
                }
            });
            ...
            new PutDataServer(new DataServiceResponder() {
                ...
                public void onResult(DataServiceResult result) {
                    if ("0".equals(result.code)) {
                        ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, true, "更改成功");
                        Constants.userMobile = phoneNum;
                        User user = User.getUser();
                        user.setPhone(Constants.userMobile);
                        CommonUtil.setUser(EditPhoneActivity.this, user);
                        SharUtil.savePhone(EditPhoneActivity.this, phoneNum);
                    } else {
                        ActivityUtil.showPopWindow4Tips(EditPhoneActivity.this, title_layout, false, "更改失败");
                    }
                }
