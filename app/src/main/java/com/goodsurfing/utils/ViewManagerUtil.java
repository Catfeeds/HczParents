...
public class ViewManagerUtil {
	...
	public void pushActivity(Activity activity) {
		activityStack.put(activity.toString(), new SoftReference<Activity>(activity));
	}
	...
	public void exit() {
		try {
			for (Iterator<Entry<String, SoftReference<Activity>>> iterator = activityStack.entrySet().iterator(); iterator.hasNext();) {
