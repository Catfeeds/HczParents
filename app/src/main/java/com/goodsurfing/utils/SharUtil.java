...
public class SharUtil {
    ...
    public static void saveServiceId(String serviceId) {
        HaoUpApplication.getInstance().getSharedPreferences(Constants.LOGIN_INFO, Activity.MODE_APPEND)
                .edit().putString(Constants.LOGIN_SERVICE_ID, serviceId).commit();
    }

    public static String getServiceId() {
        return HaoUpApplication.getInstance().getSharedPreferences(Constants.LOGIN_INFO,
                Activity.MODE_APPEND).getString(Constants.LOGIN_SERVICE_ID, "");
    }
    ...
    public static void saveExpireShow() {
        HaoUpApplication.getInstance().getSharedPreferences(Constants.LOGIN_INFO, Activity.MODE_APPEND)
                .edit().putString(Constants.LOGIN_SERVICE_ID + Constants.userMobile, ActivityUtil.getDateTime("yyyy-MM-dd")).commit();
    }

    public static boolean getExpireShow() {
        String time = HaoUpApplication.getInstance().getSharedPreferences(Constants.LOGIN_INFO, Activity.MODE_APPEND)
                .getString(Constants.LOGIN_SERVICE_ID + Constants.userMobile, "");
        return !time.equals(ActivityUtil.getDateTime("yyyy-MM-dd"));
    }
}
