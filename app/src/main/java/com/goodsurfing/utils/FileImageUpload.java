...
public class FileImageUpload {
     ...
     */   
     ...
     public static String uploadImageFile(String pathToOurFile,String urlServer) throws ClientProtocolException, IOException, JSONException {
