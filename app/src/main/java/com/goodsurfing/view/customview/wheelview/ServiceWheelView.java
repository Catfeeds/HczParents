 ...
 * 类描述: 日期选择器，轮转
 */
public class ServiceWheelView extends View {
	/** Scrolling duration */
	...
	// Listeners
	private List<OnServiceWheelChangedListener> changingListeners = new LinkedList<OnServiceWheelChangedListener>();
	private List<OnServiceWheelScrollListener> scrollingListeners = new LinkedList<OnServiceWheelScrollListener>();

	/**
	 * Constructor
	 */
	public ServiceWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public ServiceWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public ServiceWheelView(Context context) {
		super(context);
		initData(context);
	}
	...
	private void initData(Context context) {
		...
		TEXT_SIZE = ActivityUtil.dip2px(context, TEXT_SIZE);
		ITEM_OFFSET = ActivityUtil.dip2px(context, ITEM_OFFSET);
	}
	 ...
	 *            the listener
	 */
	public void addChangingListener(OnServiceWheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnServiceWheelChangedListener listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(OnServiceWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnServiceWheelScrollListener listener : scrollingListeners) {
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.draw_wheel_view_val);
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (itemsWidth > 0) {
			...
			canvas.translate(this.getWidth() /14, -ITEM_OFFSET);
			drawItems(canvas);
			drawValue(canvas);
			canvas.restore();
		}
...
Log.i("xzj", "-top + scrollingOffset=="+(-top + scrollingOffset));
