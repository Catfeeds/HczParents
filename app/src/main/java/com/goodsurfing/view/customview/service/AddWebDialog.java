...
public class AddWebDialog extends NiftyDialogBuilder implements
	...
	private static AddWebDialog instance;
	...
	public AddWebDialog(Context context, int theme) {
		super(context, theme);
	...
	public static AddWebDialog getInstance(Context context) {
		...
		if (instance == null || ((Activity) context).isFinishing()) {
			synchronized (AddWebDialog.class) {
				if (instance == null) {
					instance = new AddWebDialog(context,
	...
	private void setDialogProperties() {
		...
		this.withDialogWindows(width, LayoutParams.WRAP_CONTENT)
				.withTitle("网址类别").withTitleColor("#000000")
				.withNextText("确定")
