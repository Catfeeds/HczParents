...
public class HczTimeControlNet extends HczNetUtils {
    public HczTimeControlNet(Context context, Handler handler) {
        super(context, Constants.HCZ_TIMECONTROL_URL, handler);
    }

    public void putParams(String useTime) {
        maps.put("clientId", Constants.child.getClientDeviceId()+"");
        maps.put("uid", Constants.userId);
        maps.put("useTime", useTime);
    }
