 ...
 * 修改孩子信息
 */
public class HczUnBindChildNet extends HczNetUtils {
    public HczUnBindChildNet(Context context, Handler handler) {
        super(context, Constants.HCZ_UNBINDCHILD_URL, handler);
    }
