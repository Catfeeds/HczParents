 ...
 * 修改家长信息
 */
public class HczSetPersonInfoNet extends HczNetUtils {
    public HczSetPersonInfoNet(Context context, Handler handler) {
        super(context, Constants.HCZ_EDITPERSON_URL, handler);
    }

    public void putParams(String mobile, String name,String password) {
