...
public class HczSwitchModeNet extends HczNetUtils {
    public HczSwitchModeNet(Context context, Handler handler) {
        super(context, Constants.HCZ_SWITCHMODE_URL, handler);
    }

    public void putParams(String clientId, String modeid) {
        maps.put("clientId", clientId);
        maps.put("modeid", modeid);
