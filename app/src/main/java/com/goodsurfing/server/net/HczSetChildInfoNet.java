 ...
 * 修改孩子信息
 */
public class HczSetChildInfoNet extends HczNetUtils {
    public HczSetChildInfoNet(Context context, Handler handler) {
        super(context, Constants.HCZ_EDITCHILD_URL, handler);
    }

    public void putParams(String gender, String name,int img) {
